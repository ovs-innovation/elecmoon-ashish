              ...
              <div className="ml-3">
                <div className="flex items-center font-serif">
                  <h6 className="pl-1 text-base font-medium text-gray-600">
                    <span className="text-lg md:text-xl lg:text-xl text-[#EF4036] font-bold">
                  ...
                  <div className="ml-2">
                    {dayjs().isAfter(dayjs(coupon.endTime)) ? (
                      <span className="text-[#C53030] inline-block px-4 py-1 rounded-full font-medium text-xs bg-[#FDE8E6]">
                        Inactive
                      </span>
                    ) : (
                      <span className="text-[#C53030] inline-block px-4 py-1 rounded-full font-medium text-xs bg-[#FDE8E6]">
                ...
                {dayjs().isAfter(dayjs(coupon.endTime)) ? (
                  <span className="inline-block mb-2">
                    <div className="flex items-center font-semibold">
                      <span className="flex items-center justify-center bg-[#EF4036] text-white text-sm font-serif font-semibold mx-1 px-2 py-1 rounded">
                        00
                      </span>
                      :
                      <span className="flex items-center justify-center bg-[#EF4036] text-white text-sm font-serif font-semibold mx-1 px-2 py-1 rounded">
            ...
            <div className="md:border-l-2 lg:border-l-2 border-dashed lg:w-1/3 md:w-1/3 relative px-4">
              <div className="info flex items-center">
                <div className="w-full">
                  <div className="block">
                    <div className="font-serif border border-dashed bg-[#FDE8E6] py-1 border-[#EF4036] rounded-lg text-center block">
                      <CopyToClipboard
                      ...
                      >
                        <button className="block w-full">
                          {copied && coupon.couponCode === copiedCode ? (
                            <span className="text-[#C53030] text-sm leading-7 font-semibold">
                              Copied!
                            </span>
                          ) : (
                            <span className="uppercase font-serif font-semibold text-sm leading-7 text-[#C53030]">
                              {coupon.couponCode}{" "}
                            </span>
                          )}
                        </button>
              ...
              <div className="info flex lg:my-6 md:my-5 mb-6 items-center">
                <div className="w-full">
                  <div className="block">
                    <div className="font-serif font-medium flex items-center mb-1">
                      ...
                      <div className="ml-2">
                        {dayjs().isAfter(dayjs(coupon.endTime)) ? (
                          ...
                          <span className="text-[#C53030] inline-block">
                            Active
                          </span>
                        )}
                      </div>
                    ...
                    <div className="font-serif border border-dashed bg-green-50 py-2 border-green-900 rounded-lg text-center block">
                      <CopyToClipboard
                        text={coupon.couponCode}
                        onCopy={() => handleCopied(coupon.couponCode)}
                      >
                        <button className="block w-full">
                          {copied && coupon.couponCode === copiedCode ? (
                            <span className="text-[#C53030] text-base leading-7 font-semibold">
                              Copied!
                            </span>
                          ) : (
                            <span className="uppercase font-serif font-semibold text-base leading-7 text-[#C53030]">
                              {coupon.couponCode}{" "}
                            </span>
                          )}
                        </button>
