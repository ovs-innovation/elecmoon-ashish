              ...
              <div className="px-6 pt-8 flex-grow w-full h-full max-h-full pb-40 md:pb-32 lg:pb-32 xl:pb-32">
                ...
                {title === "Attribute Value(s)" && (
                  <>
                    ...
                    {/* Hex Color Field - Only show for Color attributes */}
                    {(() => {
                      // Check if any of the selected attributes is a color attribute
                      const selectedAttribute = attributes?.find(attr => 
                        attr._id === register('groupName')?.value
                      );
                      const isColorAttribute = selectedAttribute?.title?.en?.toLowerCase() === "color" || 
                                             selectedAttribute?.name?.en?.toLowerCase() === "color";
